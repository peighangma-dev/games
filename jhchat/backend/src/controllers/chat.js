...
exports.joinRoom = async (req, res) => {
  try {
    ...
    const room = rooms[0];
    if (room.min_grade > 0 && req.user.grade < room.min_grade && req.user.faction !== '逍遥派') {
      return res.status(403).json({ success: false, message: '等级不足' });
    }
    if (room.max_grade > 0 && req.user.grade > room.max_grade && req.user.faction !== '逍遥派') {
...
exports.getCommands = async (req, res) => {
  const allCommands = [
    ...
    { cmd: '/点穴', name: '点穴', minGrade: 1, faction: '逍遥派', file: '2' },
    { cmd: '/逮捕', name: '逮捕', minGrade: 6, faction: '逍遥派', file: '3' },
    { cmd: '/坐牢', name: '坐牢', minGrade: 8, faction: '逍遥派', file: '4' },
    { cmd: '/警告', name: '警告', minGrade: 1, faction: '逍遥派', file: '5' },
    ...
    { cmd: '/查ip', name: '查IP', minGrade: 7, faction: '逍遥派', file: '18' },
    ...
    { cmd: '/公告', name: '公告', minGrade: 1, faction: '逍遥派', file: '24' },
    { cmd: '/禁言', name: '禁言', minGrade: 1, faction: '逍遥派', file: '26' },
    { cmd: '/解禁', name: '解禁', minGrade: 1, faction: '逍遥派', file: '27' },
    { cmd: '/禁打', name: '禁打', minGrade: 1, faction: '逍遥派', file: '28' },
    { cmd: '/开打', name: '开打', minGrade: 1, faction: '逍遥派', file: '29' },
    { cmd: '/打坐', name: '打坐练功', minGrade: 1, file: '30' },
    { cmd: '/踢人', name: '踢人', minGrade: 9, faction: '逍遥派', file: '31' },
