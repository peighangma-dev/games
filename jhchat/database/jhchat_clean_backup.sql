...
INSERT INTO `admin_action_logs` VALUES (1,15,'testadmin','clear_cache','POST /server/clear-cache','::ffff:127.0.0.1','curl/7.88.1','{}','success','2026-04-22 09:47:31');
...
) ENGINE=InnoDB AUTO_INCREMENT=391 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天消息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='在线用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `secret_skills` VALUES (1,'基本吐纳术','丙','通用','内功','',1,0,8,150,1,'入门级内功心法，可缓慢提升内力','common'),(2,'初级养气诀','丙','通用','内功','',1,0,15,300,2,'基础养气功夫，内力增长稳定','common'),(3,'小周天功','丙','通用','内功','',1,0,25,600,3,'运行小周天，内力循环不息','uncommon'),(4,'草上飞','丙','通用','内功','',1,5,0,250,2,'基础轻功，行走如风','common'),(5,'燕子三抄水','丙','通用','内功','',1,10,0,500,3,'身轻如燕，提纵自如','uncommon'),(6,'神行百变','丙','通用','内功','',1,18,0,1200,5,'高深轻功，变化莫测','rare'),(7,'凌波微步','丙','通用','内功','',1,28,0,3000,8,'绝顶轻功，步法精妙','epic'),(8,'先天功','丙','通用','内功','',1,0,35,2500,6,'道家正宗内功，威力无穷','rare'),(9,'九阴真经','丙','通用','内功','',1,5,45,5000,9,'武林至宝，内外兼修','epic'),(10,'九阳神功','丙','通用','内功','',1,0,55,8000,10,'至刚至阳，内力无穷','legendary'),(11,'易筋经','丙','通用','内功','',1,10,60,10000,12,'少林镇派之宝，脱胎换骨','legendary'),(12,'北冥神功','丙','通用','内功','',1,8,50,6000,9,'吸人内力，据为己有','epic'),(13,'斗转星移','丙','通用','内功','',1,15,30,4500,7,'以彼之道还施彼身','rare'),(14,'乾坤大挪移','丙','通用','内功','',1,12,40,5500,8,'挪移乾坤，借力打力','epic'),(15,'吸星大法','丙','通用','内功','',1,5,38,4000,7,'吸取内力，但有后患','rare'),(16,'葵花宝典','丙','通用','内功','',1,35,20,7000,10,'辟邪剑法之祖，速成但代价巨大','legendary');
...
INSERT INTO `sects` VALUES (1,'逍遥派','站长',NULL,'笑傲江湖，逍遥自在','逍遥派门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48'),(2,'少林派',NULL,NULL,'天下武功出少林','少林门规',0,'male','2026-04-19 07:11:48','2026-04-19 07:11:48'),(3,'峨眉派',NULL,NULL,'峨眉天下秀','峨眉门规',0,'female','2026-04-19 07:11:48','2026-04-19 07:11:48'),(4,'武当派',NULL,NULL,'太极生两仪','武当门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48'),(5,'华山派',NULL,NULL,'华山论剑','华山门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48'),(6,'丐帮',NULL,NULL,'天下第一大帮','丐帮门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48'),(7,'明教',NULL,NULL,'焚我残躯，熊熊圣火','明教门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48'),(8,'唐门',NULL,NULL,'暗器无双','唐门门规',0,'both','2026-04-19 07:11:48','2026-04-19 07:11:48');
...
INSERT INTO `user_fortunes` VALUES (1,1,'站长','small_misfortune','小凶','今天可能会遇到一些挫折，但不要气馁！保持冷静，困难终将过去！','2026-04-19','2026-04-19 08:00:55'),(2,1,'站长','small_luck','小吉','运势还算不错！虽然不能贪心，但只要脚踏实地，会有小收获！','2026-04-20','2026-04-20 13:38:07');
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户 IP 记录历史表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'站长','$2a$10$KSpt.hn8WSs3HrEhRBal3OP1w0npd/dPoJLYDc6JBTDrlUa.ITzPi',NULL,'male',NULL,NULL,'1.gif','normal',0,102,102,10,6,100,20,10,999,100,'无',0,9937234,180,'六扇门','逍遥派','掌门',NULL,0,10,45,'2026-04-19 07:11:48',NULL,'2026-04-23 08:33:38','113.248.203.20',NULL,100704,'2026-04-20 14:03:37',3,173,0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'2026-04-19 07:11:48','2026-04-23 08:33:38'),(13,'install','$2a$10$VxlDEl2z5.wtEAAqSb7LM.XD/6Y0XJyL.uHwsypUgGK6..QSRoxPe',NULL,'male',NULL,NULL,'1.gif','normal',0,372,100,10,0,151,10,10,100,100,'无',0,924,0,'无','无','无',NULL,0,4,5,'2026-04-19 16:09:57','183.228.206.48','2026-04-22 13:21:33','183.228.206.237',NULL,1,NULL,0,0,1,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'2026-04-19 16:09:57','2026-04-22 15:37:41'),(15,'testadmin','$2a$10$q8CZfRPutZCEAK848TiY7e48urilsXRA8IyKJlRWpNJgksz7Ouvka',NULL,'male',NULL,NULL,'1.gif','normal',0,100,100,10,0,100,10,10,100,100,'无',0,0,0,'无','逍遥派','无',NULL,0,10,7,'2026-04-22 09:39:36',NULL,'2026-04-23 08:32:29','127.0.0.1',NULL,0,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'2026-04-22 09:39:36','2026-04-23 08:32:29');
...
-- Dump completed on 2026-04-23  8:41:46
