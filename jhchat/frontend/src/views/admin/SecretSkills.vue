<template>
  <div class="secret-skills-page">
    ...
    <el-row :gutter="20" class="mb-4">
      <el-col :span="6">
        <el-statistic title="秘籍总数" :value="stats.total" />
      </el-col>
      <el-col :span="6">
        <el-statistic title="甲级秘籍" :value="stats.gradeA" />
      </el-col>
      <el-col :span="6">
        <el-statistic title="乙级秘籍" :value="stats.gradeB" />
      </el-col>
      <el-col :span="6">
        <el-statistic title="丙级秘籍" :value="stats.gradeC" />
      </el-col>
    </el-row>
    ...
    <el-card class="filter-card mb-4">
      <el-form :inline="true" :model="filterForm">
        <el-form-item label="秘籍名称">
          <el-input v-model="filterForm.name" placeholder="搜索秘籍名称" clearable />
        </el-form-item>
        <el-form-item label="秘籍等级">
          <el-select v-model="filterForm.grade" placeholder="全部等级" clearable>
        ...
        <el-form-item label="门派">
          <el-select v-model="filterForm.sect" placeholder="全部门派" clearable>
      ...
      >
        ...
        <el-table-column prop="grade" label="等级" width="100">
          <template #default="{ row }">
            <el-tag :type="row.grade === '甲' ? 'danger' : row.grade === '乙' ? 'warning' : 'info'">
              {{ row.grade }}级
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="type" label="类型" width="120">
          <template #default="{ row }">
            <el-tag size="small" :type="row.type === '内功' ? 'primary' : 'success'">
              {{ row.type }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="effect" label="效果" min-width="200" />
        <el-table-column prop="price" label="价格" width="100" align="right">
          <template #default="{ row }">
            <span class="price-text">{{ row.price }} 银</span>
          </template>
        </el-table-column>
